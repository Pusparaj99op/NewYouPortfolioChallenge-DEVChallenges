...
export default function QuantitativeTradingPage() {
    ...
    return (
        <div ref={containerRef} className="min-h-screen bg-gradient-to-br from-[#050505] via-[#0a0a0a] to-[#050505] text-white p-4 md:p-8 pt-24 font-sans selection:bg-emerald-500/30 relative overflow-hidden">
            ...
            {/* Grid Layout - Pro Dashboard Structure */}
            <div ref={gridRef} className="grid grid-cols-1 lg:grid-cols-4 gap-6 relative z-10 min-h-[800px]">
                ...
                <div className="col-span-1 flex flex-col h-full">
                    <motion.div
                        ...
                        className="trading-panel flex-1 rounded-2xl relative group h-[800px]"
                    >
                ...
                <div className="col-span-1 lg:col-span-2 flex flex-col gap-6">
                    ...
                    <motion.div
                        ...
                        className="trading-panel h-[480px] relative group"
                    >
                        ...
                        <motion.div
                            ...
                            className="absolute top-4 left-4 z-10 glass-panel backdrop-blur-md p-3 rounded-xl border border-emerald-500/20 bg-black/40 shadow-lg flex items-center gap-4"
                        >
                            <div className="flex flex-col">
                                <div className="text-[10px] text-zinc-400 font-mono uppercase tracking-wider">BTC/USDT</div>
                        ...
                        <div className="absolute top-0 right-0 w-6 h-6 border-t border-r border-violet-500/30 rounded-tr-xl" />
                        <div className="absolute bottom-0 left-0 w-6 h-6 border-b border-l border-cyan-500/30 rounded-bl-xl" />
                        <div className="absolute bottom-0 right-0 w-6 h-6 border-b border-r border-emerald-500/30 rounded-br-xl" />
                    </motion.div>
                    ...
                    <motion.div
                        ...
                        className="trading-panel h-[296px] rounded-2xl glass-panel border border-white/10 bg-gradient-to-br from-zinc-900/90 via-black/95 to-zinc-900/90 backdrop-blur-xl overflow-hidden relative group"
                    >
                        {/* Terminal Header */}
                        <div className="flex items-center justify-between px-4 py-2 border-b border-white/10 bg-black/50">
                            <div className="flex items-center gap-3">
                                ...
                                <span className="text-[10px] font-mono text-zinc-500">algo-trader@blackobsidian:~</span>
                            </div>
                            <motion.button
                                onClick={() => setIsTerminalRunning(!isTerminalRunning)}
                                whileHover={{ scale: 1.05 }}
                                whileTap={{ scale: 0.95 }}
                                className={`px-2 py-0.5 rounded text-[9px] font-mono uppercase tracking-wider transition-all ${isTerminalRunning
                        ...
                        <div
                            ref={terminalRef}
                            className="p-3 h-[calc(100%-37px)] overflow-y-auto custom-scrollbar font-mono text-[10px] leading-relaxed"
                            ...
                            <AnimatePresence>
                                {terminalLogs.map((log) => (
                                    <motion.div
                                        ...
                                        exit={{ opacity: 0 }}
                                        className={`py-0.5 flex items-start gap-2 ${log.type === 'BUY' ? 'text-emerald-400' :
                ...
                <div className="col-span-1 flex flex-col gap-6">
                    ...
                    <motion.div
                        ...
                        className="trading-panel h-[380px] rounded-2xl glass-panel border border-white/10 bg-gradient-to-br from-zinc-900/80 via-zinc-900/60 to-black/80 backdrop-blur-xl p-5 flex flex-col gap-4 relative overflow-hidden group"
                    >
                        ...
                        <div className="flex items-center justify-between relative z-10">
                            <h3 className="font-semibold flex items-center gap-2 text-base">
                                ...
                                <div>
                                    ...
                                    <div className="text-[10px] text-zinc-500 font-normal">Instant Settlement</div>
                                </div>
                            </h3>
                        </div>
                        ...
                        <div className="space-y-4 relative z-10 flex-1 flex flex-col justify-center">
                            <div className="relative">
                                <label className="text-[10px] text-emerald-400 uppercase block mb-1.5 font-semibold tracking-wider flex items-center gap-2">
                                    <Layers size={12} />
                                    Amount (BTC)
                                </label>
                                <div className="relative">
                                    <input
                                        ...
                                        className="w-full bg-black/60 border border-white/10 rounded-lg p-3 text-white font-mono text-base focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500/20 outline-none transition-all backdrop-blur-sm"
                                        placeholder="0.01"
                                        step="0.001"
                                        min="0"
                                    />
                                    <div className="absolute right-3 top-1/2 -translate-y-1/2 text-[10px] text-zinc-500 font-mono">BTC</div>
                                </div>
                                {price && (
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <motion.button
                                    ...
                                    whileHover={{ scale: 1.05 }}
                                    whileTap={{ scale: 0.95 }}
                                    className="relative py-3 rounded-lg bg-gradient-to-br from-emerald-500/20 to-emerald-600/10 hover:from-emerald-500/30 hover:to-emerald-600/20 border border-emerald-500/50 text-emerald-400 font-bold text-base transition-all disabled:opacity-50 overflow-hidden group"
                                >
                                ...
                                <motion.button
                                    ...
                                    whileHover={{ scale: 1.05 }}
                                    whileTap={{ scale: 0.95 }}
                                    className="relative py-3 rounded-lg bg-gradient-to-br from-rose-500/20 to-rose-600/10 hover:from-rose-500/30 hover:to-rose-600/20 border border-rose-500/50 text-rose-400 font-bold text-base transition-all disabled:opacity-50 overflow-hidden group"
                                >
                                    <span className="relative z-10 flex items-center justify-center gap-1.5">
                            ...
                            <AnimatePresence>
                                {tradeStatus && (
                                    <motion.div
                                        ...
                                        animate={{ opacity: 1, y: 0 }}
                                        exit={{ opacity: 0, y: 5 }}
                                        className={`text-xs p-2 rounded-lg font-mono text-center ${tradeStatus.startsWith('Error')
                            ...
                            <div className="pt-4 border-t border-white/10 space-y-2">
                                <div className="flex justify-between text-xs">
                                    <span className="text-zinc-500 flex items-center gap-1"><DollarSign size={12} /> USDT</span>
                                    <span className="font-mono text-emerald-400">${portfolio.usdt_balance.toFixed(2)}</span>
                                </div>
                                <div className="flex justify-between text-xs">
                                    <span className="text-zinc-500 flex items-center gap-1"><Activity size={12} /> BTC</span>
                                    <span className="font-mono text-cyan-400">{portfolio.btc_balance.toFixed(6)}</span>
                                </div>
                            </div>
                        </div>
                    </motion.div>
                    ...
                    <motion.div
                        ...
                        transition={{ delay: 0.5 }}
                        whileHover={{ scale: 1.01 }}
                        className="trading-panel h-[400px] rounded-2xl glass-panel border border-white/10 bg-gradient-to-br from-zinc-900/80 via-zinc-900/60 to-black/80 backdrop-blur-xl p-5 flex flex-col gap-3 relative overflow-hidden group"
                    >
                        ...
                        <div className="flex items-center gap-3 mb-2 relative z-10">
                            <motion.div
                                ...
                                className="p-2 rounded-lg bg-gradient-to-br from-pink-500/20 to-purple-500/20"
                            >
                                <Cpu size={18} className="text-pink-400" />
                            </motion.div>
                            <div>
                                <h3 className="font-semibold text-sm">AI Market Sentiment</h3>
                                <p className="text-[9px] text-zinc-500 font-mono">Gemini AI Model</p>
                            </div>
                        </div>

                        <div className="space-y-3 flex-1 overflow-y-auto custom-scrollbar relative z-10 pr-1">
                            {[
                                { text: "Bullish divergence detected on 4H. Accumulation active.", sentiment: "positive", confidence: 87 },
                                { text: "Whale movement at $95.8k level support.", sentiment: "neutral", confidence: 72 },
                                { text: "Volume spike implies volatility ahead.", sentiment: "warning", confidence: 81 },
                            ].map((item, i) => (
                                <div key={i} className="p-3 rounded-xl bg-white/5 border border-white/10 backdrop-blur-sm relative overflow-hidden">
                                    <div className="flex justify-between mb-1.5 relative z-10">
                                        <span className={`text-[9px] px-1.5 py-0.5 rounded font-bold uppercase tracking-wider ${item.sentiment === 'positive' ? 'bg-emerald-500/20 text-emerald-400' : item.sentiment === 'neutral' ? 'bg-blue-500/20 text-blue-400' : 'bg-amber-500/20 text-amber-400'}`}>
                                            {item.sentiment}
                                        </span>
                                        <span className="text-[9px] text-zinc-500 font-mono">{90 - i * 15}s ago</span>
                                    </div>
                                    <p className="text-[10px] text-zinc-300 leading-snug mb-2 relative z-10">{item.text}</p>
                                    <div className="h-1 bg-white/5 rounded-full overflow-hidden relative z-10">
                                        <div className={`h-full ${item.sentiment === 'positive' ? 'bg-emerald-500' : item.sentiment === 'neutral' ? 'bg-blue-500' : 'bg-amber-500'}`} style={{ width: `${item.confidence}%` }}></div>
                                    </div>
                                </div>
                            ))}
                        </div>
                        <motion.button whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} className="w-full py-2.5 rounded-xl bg-gradient-to-r from-pink-500/20 to-purple-500/20 border border-pink-500/30 text-xs font-semibold text-white relative z-10 group/btn overflow-hidden">
                            <span className="relative z-10 flex items-center justify-center gap-2"><Zap size={14} /> Full Report</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mt-6 relative z-10">
                <motion.div whileHover={{ scale: 1.02 }} className="rounded-2xl glass-panel border border-white/10 bg-gradient-to-br from-zinc-900/80 to-black/80 backdrop-blur-xl p-4 flex items-center justify-between group">
                    <div>
                        <div className="text-[10px] text-zinc-500 uppercase tracking-wider font-semibold flex items-center gap-2 mb-1">
                            <PieChart size={12} className="text-emerald-400" /> 24h Volume
                        </div>
                        <div className="text-2xl font-mono font-bold text-white">$4.2B</div>
                    </div>
                    <div className="text-xs text-emerald-400 font-mono bg-emerald-500/10 px-2 py-1 rounded">↑ 12.4%</div>
                </motion.div>

                <motion.div whileHover={{ scale: 1.02 }} className="rounded-2xl glass-panel border border-white/10 bg-gradient-to-br from-zinc-900/80 to-black/80 backdrop-blur-xl p-4 flex items-center justify-between group">
                    <div>
                        <div className="text-[10px] text-zinc-500 uppercase tracking-wider font-semibold flex items-center gap-2 mb-1">
                            <Activity size={12} className="text-violet-400" /> Open Interest
                        </div>
                        <div className="text-2xl font-mono font-bold text-white">$8.7B</div>
                    </div>
                    <div className="text-xs text-violet-400 font-mono bg-violet-500/10 px-2 py-1 rounded">L/S: 52/48</div>
                </motion.div>

                <motion.div whileHover={{ scale: 1.02 }} className="rounded-2xl glass-panel border border-white/10 bg-gradient-to-br from-zinc-900/80 to-black/80 backdrop-blur-xl p-4 flex items-center justify-between group">
                    <div>
                        <div className="text-[10px] text-zinc-500 uppercase tracking-wider font-semibold flex items-center gap-2 mb-1">
                            <Zap size={12} className="text-cyan-400" /> Funding Rate
                        </div>
                        <div className="text-2xl font-mono font-bold text-white">0.0125%</div>
                    </div>
                    <div className="text-xs text-cyan-400 font-mono bg-cyan-500/10 px-2 py-1 rounded">4h 23m</div>
                </motion.div>

                <motion.div whileHover={{ scale: 1.02 }} className="rounded-2xl glass-panel border border-white/10 bg-gradient-to-br from-zinc-900/80 to-black/80 backdrop-blur-xl p-4 flex items-center justify-between group">
                    <div>
                        <div className="text-[10px] text-zinc-500 uppercase tracking-wider font-semibold flex items-center gap-2 mb-1">
                            <BarChart3 size={12} className="text-amber-400" /> 24h High/Low
                        </div>
                    ...
                    <div className="text-xs text-amber-400 font-mono bg-amber-500/10 px-2 py-1 rounded">3.29%</div>
                </motion.div>
            </div>
