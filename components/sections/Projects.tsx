...
const projects = [
    {
        ...
        description: 'Real-time visualization of market microstructure. Tracks institutional volume and order book imbalances.',
        category: 'Trading',
        tech: ['Python', 'React', 'D3.js'],
        metrics: { label: 'Sharpe', value: '1.8' },
        link: '#',
    ...
    },
    {
        id: 2,
        title: 'Arbitrage Bot',
        description: 'Low-latency execution system capturing spread inefficiencies across multiple exchanges.',
        category: 'Trading',
        tech: ['Rust', 'Python', 'Redis'],
        metrics: { label: 'Latency', value: '5ms' },
        link: '#',
    ...
    },
    {
        ...
        description: 'Risk management platform with VaR calculations, scenario analysis, and live P&L tracking.',
        category: 'Finance',
        tech: ['Next.js', 'PostgreSQL', 'AWS'],
        metrics: { label: 'Assets', value: '$1M+' },
        link: '#',
    ...
    {
        id: 4,
        title: 'Solana NFT Sniper',
        description: 'Automated sniping tool for Solana NFT marketplaces. Monitors mempool for pending listings.',
        category: 'Web3',
        tech: ['TypeScript', 'Solana Web3.js'],
        metrics: { label: 'Success', value: '94%' },
        link: '#',
...
export default function Projects() {
    ...
    return (
        <section id="projects" className="section bg-gradient-to-b from-black via-black/95 to-black relative overflow-hidden">
